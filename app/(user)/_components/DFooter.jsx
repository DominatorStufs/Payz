...
export default function DFooter() {
    return (
        <footer className="mt-20 mb-10 px-6 md:px-20 lg:px-32 grid place-content-center text-center">
            <Logo/>
            <p className="text-xs mb-4">Built using nextjs by <a className="hover:text-primary hover:underline" href="https://wa.me/919968778724">☠️DOMINATOR☠️</a></p>
            ...
            <ul className="list-none flex gap-2 items-center">
                <li><a target="_blank" className="transition bg-secondary py-1 px-3 rounded-full hover:bg-primary text-sm" href="https://instagram.com/dominator.onscreen">Instagram</a></li>
                <li><a target="_blank" className="transition bg-secondary py-1 px-3 rounded-full hover:bg-primary text-sm" href="https://github.com/DominatorStufs">Github</a></li>
            </ul>
